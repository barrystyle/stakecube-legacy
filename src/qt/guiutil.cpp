...
bool parseBitcoinURI(const QUrl &uri, SendCoinsRecipient *out)
{
    ...
    if(uri.scheme() != QString("stakecube"))
        return false;
...
bool parseBitcoinURI(QString uri, SendCoinsRecipient *out)
{
    ...
    if(uri.startsWith("stakecube://"))
    {
        uri.replace(0, 12, "stakecube:");
    }
...
{
    return GetSpecialFolderPath(CSIDL_STARTUP) / "Netko.lnk";
}
...
void SetBlackThemeQSS(QApplication& app)
{
    app.setStyleSheet("QWidget        { background: rgb(41,44,48); }"
                      ...
                      "QPushButton    { background: rgb(206,222,0); color: rgb(21,21,21); }"
                      ...
                      "QTabBar::tab   { color: rgb(120,127,139); border: 1px solid rgb(206,222,0); border-bottom: none; padding: 5px; }"
                      "QTabBar::tab:selected  { background: rgb(41,44,48); }"
                      "QTabBar::tab:!selected { background: rgb(24,26,30); margin-top: 2px; }"
                      "QTabWidget::pane { border: 1px solid rgb(206,222,0); }"
                      ...
                      "QToolButton:checked { color: rgb(255,255,255); border: none; border-left-color: rgb(206,222,0); border-left-style: solid; border-left-width: 6px; }"
